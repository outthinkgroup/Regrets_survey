...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(584) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(567).concat(__webpack_require__(909)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(567).concat(__webpack_require__(909)) },
        gb18030: function() { return __webpack_require__(321) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(244).concat(__webpack_require__(174)) },
...
try {
    ...
    iconv_package = 'iconv';
    Iconv = __webpack_require__(511).Iconv;
} catch (E) {
...
var bomHandling = __webpack_require__(994),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(917); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(936)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(456)(iconv);
}
...
let convert;
try {
	convert = __webpack_require__(900).convert;
} catch (e) {}
...
var iconvLite = __webpack_require__(734);
// Load Iconv from an external file to be able to disable Iconv for webpack
// Add /\/iconv-loader$/ to webpack.IgnorePlugin to ignore it
var Iconv = __webpack_require__(624);
